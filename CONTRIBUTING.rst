...
Report bugs at https://github.com/rnag/wystia/issues.
...
Wistia API Helper could always use more documentation, whether as part of the
official Wistia API Helper docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/rnag/wystia/issues.
...
Ready to contribute? Here's how to set up `wystia` for local development.

1. Fork the `wystia` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/wystia.git
